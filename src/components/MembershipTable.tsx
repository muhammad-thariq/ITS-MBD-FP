...
interface MembershipFormState {
    ...
    m_points: string; // Use string for input, convert to number for API
}
...
const MembershipTable: React.FC<MembershipTableProps> = ({
    ...
    const fetchAllCustomers = useCallback(async () => {
        try {
            ...
            setError(err.message); // This might block the modal if not handled gracefully
        }
    }, []);
    ...
    const handleAddEditSubmit = async (e: React.FormEvent) => {
        ...
        const payload = {
            ...
            m_points: parseInt(formState.m_points, 10),
        };
    ...
    const openEditModal = (membership: Membership) => {
        ...
        setFormState({
            ...
            m_points: membership.m_points.toString(),
        });
        setIsModalOpen(true);
    };
