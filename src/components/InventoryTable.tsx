...
const InventoryTable: React.FC<InventoryTableProps> = ({
    ...
    const fetchInventory = useCallback(async () => {
        ...
        try {
            ...
            let errorMessage = 'An unexpected error occurred while fetching inventory items.';
    ...
    const handleAddEditSubmit = async (e: React.FormEvent) => {
        ...
        let body: InventoryItem | Omit<InventoryItem, 'i_id'>; // More specific type for body
        ...
        if (method === 'PUT') {
            ...
            // For POST, i_id is generated by the backend
            body = payload;
        }
        ...
        try {
            ...
            let errorMessage = `An unexpected error occurred while trying to ${method === 'POST' ? 'add' : 'update'} the inventory item.`;
            if (err instanceof Error) {
                errorMessage = err.message;
            } else if (typeof err === 'string') {
                errorMessage = err;
    ...
    const handleDeleteInventory = async () => {
        ...
        try {
            ...
            let errorMessage = 'An unexpected error occurred while deleting the inventory item.';
            if (err instanceof Error) {
                errorMessage = err.message;
            } else if (typeof err === 'string') {
                errorMessage = err;
